...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_OUTPUT_APPEND = 7,              /* OUTPUT_APPEND  */
...
static const char *const yytname[] =
{
  ...
  "INPUT", "OUTPUT", "OUTPUT_APPEND", "WORD", "$accept", "input", "lines",
  "oneline", "$@1", "eoln", "line", YY_NULLPTR
};
